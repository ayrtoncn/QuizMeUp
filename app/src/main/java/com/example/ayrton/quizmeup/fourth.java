...
public class fourth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = intent.getStringExtra(third.EXTRA_MESSAGE);
    ...
    public void submit(View V){
        ...
        if(C.isChecked()) {
            IntScore += 2;
            changeScore(IntScore);
            Toast.makeText(fourth.this,"Your answer correct",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(fourth.this,"Your answer incorrect",Toast.LENGTH_LONG).show();
        }
